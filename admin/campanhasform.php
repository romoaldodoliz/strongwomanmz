...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] === UPLOAD_ERR_OK) {
        ...
        if (strpos($tipo_arquivo, "image") !== false) {
            ...
            $sql = "INSERT INTO campanhas (foto, descricao, data) VALUES ('$imagem_bin', '$descricao', '$data')";

            if ($conn->query($sql) === TRUE) {
                echo "<script>window.alert('Campanha registado com sucesso!')</script>";
                echo "<script>window.location='campanhas.php'</script>";
            } else {
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Criar campanha</h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
