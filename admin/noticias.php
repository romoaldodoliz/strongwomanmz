...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Noticias</h4>
        <div class="" style="padding-bottom: 10px;">
            <a class='btn btn-dark' href="noticiasform.php">Adicionar noticia</a>
        </div>
        <div class="card">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . $row["data"] . "</td>";
                                echo "<td>";
                                echo "<form method='POST' action='remover_noticia.php'>";
