...
if (isset($_POST['submit'])) {
    ...
    $link = $_POST["link"];
    $sql = "INSERT INTO comunitarias (titulo, descricao, link) VALUES ('$titulo', '$descricao', '$link')";

    // Executar a consulta de inserção
    if ($conn->query($sql) === TRUE) {
        echo "<script>window.alert('Abordagens comunitarias criada com Sucesso!')</script>";
        echo "<script>window.location='comunitarias.php'</script>";
    } else {
