    ...
    if (isset($_POST['submit'])) {
        ...
        if (isset($_FILES['imagem']) && $_FILES['imagem']['error'] === UPLOAD_ERR_OK) {
            ...
            if (strpos($tipo_arquivo, "image") !== false) {
                ...
                $sql = "INSERT INTO galeria (titulo, descricao, link, foto, tipo) VALUES ('$titulo', '$descricao', ' ', '$imagem_bin', 'imagem')";
...
<div class="content-wrapper">
    ...
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Adicionar Imagem dos eventos/visitas</h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
