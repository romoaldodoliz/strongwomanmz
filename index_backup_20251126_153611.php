    ...
    <div class="container">
        ...
        <div class="row">
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<p class="text-center">Nenhum evento disponível.</p>';
            }
            ?>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-4 text-center mb-4">
                <div class="team-member">
                    <img class="img-fluid mb-3" src="assets/img/a4.jpg" style="height: auto; width:200px; border-radius:15px;" alt="Palmira Mucavele">
